...
namespace StorageSystemConfiguration {
	struct StorageConfig {
		...
		float GrowthRequirementSave{0.30};// Disabled: 0.00, 0.00-1.00 growth range, so it's bottom range value, top one always 1.00
		float GrowthRequirementLoad{0.30};// Disabled: 1.00, 0.00-1.00 growth range, so it's top range value, bottom one always 0.00
